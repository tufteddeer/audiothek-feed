# based on https://github.com/reckenrode/nix-foundryvtt/blob/main/modules/foundryvtt/default.nix
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.audiothekfeed = {
      ...
      serviceConfig = {
        ...
        SystemCallFilter = [ "@system-service" "~@privileged" "~@resources" "@pkey" "~@mount" ];
        # UMask = "0027";
      };
